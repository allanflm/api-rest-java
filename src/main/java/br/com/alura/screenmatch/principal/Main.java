    ...
    public void exibeMenu() {
        ...
        while (opcao != 0) {
            var menu = """
                    ...
                    7 - Buscar Series por categoria / genero.
                    8 - Filtrar séries.
                    9 - Buscar episódios por trecho.
                    10 - Buscar os melhores episodios da série.
                    11 - Buscar episodios por uma data.
                    0 - Sair.                                
                    """;
...
//        dadosSeries.add(dados);
    ...
    private void buscarSeriesPorAtor() {
        ...
        var nomeAuto = leitura.nextLine();
        System.out.println("Avaliação a partir de qual valor? ");
        var avaliacao = leitura.nextDouble();
        List<Serie> seriesEncontradas = repository.findByAtoresContainingIgnoreCaseAndAvaliacaoGreaterThanEqual(nomeAuto, avaliacao);
        System.out.println("Series em que o " + nomeAuto + " trabalhou.");
    ...
    private void buscarEpisodiosDepoisDeUmaData() {
        ...
        if (serieBusca.isPresent()) {
            Serie serie = serieBusca.get();
            System.out.println("Digite o ano limte de lançamento: ");
